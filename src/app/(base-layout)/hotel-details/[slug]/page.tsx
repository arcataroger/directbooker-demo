...
function ContactLinks(props: { hotel: any }) {
  return (
    <div className="flex-wrap hstack gap-2">
      <div className="d-flex">
        ...
        <p className="body-text small my-0 align-self-end">
          <a target="_blank" href={`tel:${props.hotel.phone}`}>
            {props.hotel.phone}
          </a>
        </p>
      </div>
      ...
      <div className="d-flex">
        ...
        <p className="body-text small my-0 align-self-end">
          {props.hotel.website && (
            <a target="_blank" href={props.hotel.website}>
              {new URL(props.hotel.website).host}
            </a>
          )}
        </p>
      </div>
...
function DirectContactBar(props: { hotel: any }) {
  return (
    <div className="border border-grey-mid rounded-2 d-flex flex-wrap gap-4 align-items-center justify-content-center p-12px">
      ...
      <ContactLinks hotel={props.hotel} />
    </div>
  );
}
      ...
      <main className="d-flex flex-column flex-grow-1 h-100">
        ...
        <div className="tw-mx-auto tw-container tw-px-3">
          ...
          <div className="vstack gap-3">
            {hotel.faq && (
              <>
                <h2>Frequently Asked Questions (FAQs) for {hotel.name}</h2>
                <StructuredText
                  data={hotel.faq}
            ...
            {hotel.brand && (
              <>
                <h2>More FAQs for {hotel.brand.brandName}</h2>
